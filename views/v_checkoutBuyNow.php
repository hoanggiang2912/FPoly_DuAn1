...
if (isset($_SESSION['userLogin']) && is_array($_SESSION['userLogin'])) {
    ...
    $updateAddressNoti =
        <<<HTML
            <a href="?mod=page&act=login" class="primary-text">Bạn chưa có thông tin mua hàng! Đăng nhập để cập nhật ngay (Bạn vẫn có thể mua hàng kể cả khi không đăng nhập)</a>
        HTML;
}
?>
